...
contract Class_Room_Struct_Mapping {
    ...
    function Save(string memory _rollNumber, string memory _name, uint256 _mark1, uint256 _mark2, uint256 _mark3) public {
    ...
    function View(string memory _rollno) public view returns (string memory, uint256){
